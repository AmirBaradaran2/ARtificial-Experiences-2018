...
public class MyDroidRobotController : MonoBehaviour {

    public float offset = 15f;
    public GameObject offsetTarget;
    public Vector3 targetRotation;

    private MyRobotCharacter character;
    ...
    private void Start()
    {
        character = GetComponent<MyRobotCharacter>();
    ...
    public IEnumerator putDown(GameObject obj)
    {
        ...
        print("[DroidRobotController]: Putting down.");
